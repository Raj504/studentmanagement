                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="d-flex justify-content-center">
                            <a href="{{ url('/batches/' . $item->id) }}" title="View batch" class="btn btn-info btn-sm mr-1">
                                <i class="fa fa-eye" aria-hidden="true"></i> View
                            </a>   
                            <a href="{{ url('/batches/' . $item->id . '/edit') }}" title="Edit batch" class="btn btn-primary btn-sm mr-1">
